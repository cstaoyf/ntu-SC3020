...
\begin{sol}
    ...
    \extraspacing {\bf Solution.} (b) By swapping non-conflicting operations, it is possible to convert the schedule to the serial schedule $T_1, T_2, T_3$. Therefore, the strongest isolation level is \ttt{SERIALIZABLE}.
\end{sol}
