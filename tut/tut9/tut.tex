...
\begin{center}
    \begin{tabular}{c|c}
        ...
        $T_1: \ttt{READ}(B)$ & $T_1: \ttt{READ}(B)$  \\
        $T_1: \ttt{WRITE}(B)$ & $T_1: \ttt{WRITE}(B)$ \\
        $T_1: \ttt{WRITE}(A)$ & $T_2: \ttt{READ}(B)$  \\
        $T_2: \ttt{READ}(B)$ & $T_2: \ttt{WRITE}(B)$  \\
        $T_2: \ttt{WRITE}(B)$ & $T_3: \ttt{READ}(C)$  \\
        $T_2: \ttt{READ}(C)$ & $T_3: \ttt{WRITE}(C)$  \\
        $T_2: \ttt{WRITE}(C)$ & $T_2: \ttt{READ}(C)$  \\
        $T_3: \ttt{READ}(C)$ & $T_2: \ttt{WRITE}(C)$  \\
        $T_3: \ttt{WRITE}(C)$ & $T_1: \ttt{WRITE}(A)$
    \end{tabular}
\end{center}
