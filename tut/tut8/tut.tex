...
\noindent Provide an argument to show that the above plan performs no more than $13 \times 10^6$ I/Os. Whenever needed, you can make the good hashing assumption for HJ.
...
\noindent Provide an argument to show that the above plan performs no more than $5 \times 10^6$ I/Os. Whenever needed, you can make (i) the no-skew assumption for sort-join (SJ) and (ii) the good hashing assumption for HJ.
...
\noindent describe a plan to process the query in at most $XXX \times 10^6$ I/Os.
