...
\extraspacing {\bf Problem 4.} Let $S$ be a set of integers stored in 10000 blocks. If the memory has $M = 100$ blocks. How many merging steps are required to sort $S$?
