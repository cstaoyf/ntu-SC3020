...
\myfrm{
    ...
    The assumption allows us to simplify the discussion and concentrate on the core principles behind MVCC's support for ``read committed''. It is not difficult to remove the assumption once those principles are clear.
...
\myfrm{
    ...
    \cbox{yellow}{
        \blue{Think:} How would you modify the protocol to support tuple deletions?
    }
}
%-------------------------------------------------------------
\end{document} 
