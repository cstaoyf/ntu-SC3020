...
\begin{small}
    ...
    \cbox{red}{
        \bred{Transactions may fail}. When they do, the system's \blue{recovery module} must perform a \blue{rollback} to cancel their modifications to the database.
    }
...
\myfrm{
    ...
    \cbox{red}{
        A transaction may fail at every instruction.
    }
