...
\myfrm{
    \cbox{green}{
        ...
        In the redo phase, the recovery algorithm sets the disk copy of $A$ to 11. The undo phase finds no disk modifications necessary.
    }
}
%-------------------------------------------------------------
\myfrm{
    \cbox{green}{
        ...
        The redo phase finds no disk modifications necessary. The undo phase
...
\myfrm{
    \cbox{green}{
        ...
        \cbox{red}{
            Can this log be created if we use a concurrency control protocol you learned from this course?
        }
    }
}
%-------------------------------------------------------------
