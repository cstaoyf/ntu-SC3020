...
\begin{small}
    ...
    The protocol we will learn is implemented in PostgreSQL.
\end{small}    
\end{frame}
%-------------------------------------------------------------
\myfrm{
...
\myfrm{
    ...
    \cbox{blue}{
        ...
        \myitems{
            ...
            \myitems{
                \item $v$ is version of $t$ that ever existed;
                \item $\idins$ is the ID of the transaction that created $v$;
                \item $\iddel$ is the ID of the transaction that deleted $v$ or \ttt{\red{NULL}} if $v$ has not been deleted;
            }
