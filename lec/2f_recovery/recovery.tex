...
\myfrm{
    ...
    \myitems{
        ...
        \blue{Meaning:} transaction $\red{T}$ will change a tuple's attribute $\red{A}$, and the attribute's value on disk is $\red{a_{old}}$ currently.
    }
}
%-------------------------------------------------------------
\myfrm{
...
\myfrm{
    ...
    \myitems{
        ...
        \blue{Meaning:} transaction $\red{T}$ will change a tuple's attribute $\red{A}$ to $\red{a_{new}}$, and the attribute's value on disk is $\red{a_{old}}$ currently.
    }
}
%-------------------------------------------------------------
\myfrm{
