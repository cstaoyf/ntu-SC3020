...
\myfrm{
    ...
    We will introduce three logging methods --- all in the so-called \blue{write-ahead logging} category --- which use different sets of log records. However, three three records are \bred{common to all methods}.

    \myitems{
        \item \red{\dblog{START $T$}}: Records the start of transaction $T$. This must be the first log record of $T$.
...
\myfrm{
    ...
    \myitems{
        ...
        \blue{Meaning:} transaction $\red{T}$ will change a tuple's attribute $\red{A}$, and the attribute's value is $\red{a_{old}}$ currently.
    }
}
%-------------------------------------------------------------
\myfrm{
...
\myfrm{
    ...
    \myitems{
        ...
        \blue{Meaning:} transaction $\red{T}$ will change a tuple's attribute $\red{A}$ to $\red{a_{new}}$, and the attribute's value is $\red{a_{old}}$ currently.
    }
}
%-------------------------------------------------------------
\myfrm{
